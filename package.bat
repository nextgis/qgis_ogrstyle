...
xcopy i18n\copy_ogr_style_ru.ts copy_coords\i18n\copy_ogr_style_ru.ts
lrelease copy_coords\i18n\copy_ogr_style_ru.ts
del copy_coords\i18n\copy_ogr_style_ru.ts
